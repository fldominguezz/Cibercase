    ...
    try:
        ...
        for ticket in tickets_to_process:
            ...
            if (original_creado_en and original_creado_en != ticket.creado_en) or \
               (original_actualizado_en and original_actualizado_en != ticket.actualizado_en):
                reverted_count += 1
                print(f"Ticket ID {ticket.id}: Creado_en reverted from {original_creado_en} to {ticket.creado_en}, Actualizado_en reverted from {original_actualizado_en} to {ticket.actualizado_en}")
